...
Public Class FininshingsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SSDBankERPSystem.FininshingsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFininshingsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FininshingsReport = New FininshingsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
