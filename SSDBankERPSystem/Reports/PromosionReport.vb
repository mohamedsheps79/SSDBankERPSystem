...
Public Class PromosionReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SSDBankERPSystem.PromosionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPromosionReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PromosionReport = New PromosionReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
